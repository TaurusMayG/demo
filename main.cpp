...
{
    vnn_ReleaseMatch0719Uint8( graph, TRUE );
...
{
    return vnn_PostProcessMatch0719Uint8( graph );
}
    ...
    )
{
    ...
    if(vnn_UseImagePreprocessNode())
    {
        return vnn_PreProcessMatch0719Uint8_ImageProcess(graph, inputs, input_num);
    }
    */
    return vnn_PreProcessMatch0719Uint8( graph, inputs, input_num );
}
    ...
    )
{
    ...
    tmsStart = get_perf_count();
    graph = vnn_CreateMatch0719Uint8( data_file_name, NULL,
